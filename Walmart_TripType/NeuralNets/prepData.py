...
from config_v2 import fineline_dict, header_list4
...
def getHeader(train):
	...
	header_list = header_list1 + header_list2 + header_list3 + header_list4
...
if __name__ == "__main__":
	...
	train_out_file = data_path + "train_mod_v2.csv"
	test_out_file = data_path + "test_mod_v2.csv"
	...
	train_header = getHeader(train=1)
